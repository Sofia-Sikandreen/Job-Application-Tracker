...
{ color: "bg-accent-sky", icon: <Calendar className="h-4 w-4" /> },
{ color: "bg-primary", icon: <CheckCircle2 className="h-4 w-4" /> },
{ color: "bg-accent-amber", icon: <Mic className="h-4 w-4" /> },
{ color: "bg-accent-coral", icon: <Award className="h-4 w-4" /> },
{ color: "bg-status-rejected", icon: <XCircle className="h-4 w-4" /> },
];
...
return (
    <Card className="min-w-[280px] flex-shrink-0 bg-card text-card-foreground rounded-3xl shadow-md border border-border p-0">
    <CardHeader className={`${config.color} text-white flex items-center justify-between rounded-t-3xl p-4`}>
        <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 p-1 bg-white/25 rounded-full">
            {config.icon}
    ...
    <CardContent ref={setNodeRef} className={`space-y-3 pt-4 bg-background-soft min-h-[400px] rounded-b-3xl p-4 ${ isOver ? "ring-2 ring-primary" : ""}`}>
...
return (
    <div ref={setNodeRef} style={style} className="rounded-2xl shadow-sm hover:shadow-md transition-all bg-surface">
    <JobApplicationCard
        job={job}
        columns={columns}
